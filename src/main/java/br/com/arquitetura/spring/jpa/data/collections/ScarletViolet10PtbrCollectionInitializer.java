...
public class ScarletViolet10PtbrCollectionInitializer implements CollectionInitializer {
    ...
    public List<CardModel> getCards() {
        ...
        cards.add(buildCard(
                    "Rellor", 24, CardTypeEnum.GRASS, "H",
                        CardRarityEnum.COMMON,
                        List.of(CardVariantEnum.NORMAL, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Rabsca ex", 25, CardTypeEnum.GRASS, "H",
                        CardRarityEnum.DOUBLE_RARE,
                        List.of(CardVariantEnum.HOLO),
        ...
        cards.add(buildCard(
                    "Articuno da Equipe Rocket", 51, CardTypeEnum.WATER, 
                        CardRarityEnum.RARE,
                        List.of(CardVariantEnum.HOLO, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Rotom Lavagem", 61, CardTypeEnum.WATER, 
                        CardRarityEnum.COMMON,
                        List.of(CardVariantEnum.NORMAL, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Hippopotas", 105, CardTypeEnum.FIGHTING, "H",
                        CardRarityEnum.COMMON,
                        List.of(CardVariantEnum.NORMAL, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Hippowdon", 106, CardTypeEnum.FIGHTING, "H",
                        CardRarityEnum.UNCOMMON,
                        List.of(CardVariantEnum.NORMAL, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Máquina de MT", 181, CardTypeEnum.ITEM, "H",
                        CardRarityEnum.UNCOMMON,
                        List.of(CardVariantEnum.NORMAL, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Energia da Equipe Rocket", 182, CardTypeEnum.SPECIAL_ENERGY, 
                        CardRarityEnum.UNCOMMON,
                        List.of(CardVariantEnum.NORMAL, CardVariantEnum.REVERSE_HOLO),
        ...
        cards.add(buildCard(
                    "Houndoom da Equipe Rocket", 191, CardTypeEnum.FIRE, 
                        CardRarityEnum.ILLUSTRATION_RARE,
                        List.of(CardVariantEnum.HOLO),
        ...
        cards.add(buildCard(
                    "Torre de Interferência", 243, CardTypeEnum.STADIUM, "H",
                        CardRarityEnum.SECRET_RARE,
                        List.of(CardVariantEnum.HOLO),
                        "https://assets.pokemon.com/static-assets/content-assets/cms2-pt-br/img/cards/web/SV10/SV10_PT-BR_243.png"
                ));

        cards.add(buildCard(
                    "Levincia", 244, CardTypeEnum.STADIUM, 
                        CardRarityEnum.SECRET_RARE,
                        List.of(CardVariantEnum.HOLO),
                        "https://assets.pokemon.com/static-assets/content-assets/cms2-pt-br/img/cards/web/SV10/SV10_PT-BR_244.png"
                ));
